...
public class ConfigurationHelpers
{
   ...
   public const string DefaultRoutePattern =
   ...
   public const string EnableSqlCommandLoggingKey =
      "Diagnostics:EntityFrameworkOptions:EnableSqlCommandLogging";
   public const string InMemoryDatabaseNameKey =
   ...
   public const string SkipFileWhenTargetTableHasRowsKey =
   ...
   public const string ThrowOnUnmatchedJsonFilesKey =
      "Database:Seed:ThrowOnUnmatchedJsonFiles";
   public const string UseSqlServerIdentityInsertWhenNeededKey =
